...
--
-- Hôte : localhost:3306
-- Généré le : mer. 12 oct. 2022 à 22:37
...
CREATE TABLE `ox_users` (
  ...
  `telephone` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'Téléphone',
...
INSERT INTO `ox_users` (`acronyme`, `nom`, `prenom`, `statut`, `mail`, `telephone`, `adresse`, `cpostal`, `commune`) VALUES
('cazcar', 'Cazzaniga ', 'Carla', 'user', 'carla.cazzaniga@belgacom.net', '0495352845', 'rue du Friquet 17', '1170', ''),
('dannat', 'DANAILOV', 'Natalia', 'user', 'natalia.danailov@skynet.be', '0032476702074', 'rue Hospice Communal 171', '1170', 'Watermael Boitsfort'),
('admadm', 'Admin', 'Admin', 'admin', 'root@sio2.be', '', '', '', '');
